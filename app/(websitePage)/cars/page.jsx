    ...
    <section className="h-90 bg-linear-to-b from-[#E8EAFA] via-[#f4f5fa] to-[#fafafa] px-auto mt-12">
          ...
          <div className="mx-auto flex  max-w-6xl py-10 flex-col items-center justify-center">
            ...
            <div className="mb-4 flex items-center gap-2 rounded-full border border-[#cbd2ec] bg-[#D9DCFC] px-3 py-1 text-sm font-semibold text-[#3B4BF7]  shadow-sm">
              ...
              <span>More than 12 vehicles active</span>
            </div>
    
    
            {/* Title */}
            <h1 className="mb-5 text-center font-Playfair Display, Georgia, serif text-[1px] font-bold tracking-tight text-[#1d2533] md:text-5xl">
              Smart Choices for{" "}
            ...
            {/* Search Box */}
            <div className="flex w-full max-w-190 h-16 overflow-hidden rounded-[26px] border border-[#e1e3ea] bg-gray-100 shadow-[0_8px_30px_rgba(30,40,90,0.08)]">
              ...
              <div className="flex flex-1 items-center px-4 gap-2">
                ...
                <input
                  type="text"
                  placeholder="Car name, brand or model..."
            ...
            {/* Locations */}
            <div className="mt-4 flex max-w-160 flex-wrap justify-center gap-2">
    
              {locations.map((location) => (
                <button
                  key={location}
                  className="flex items-center gap-1 max-w-50 rounded-full border border-[#f7f7f9] bg-white/50 px-4 py-1 text-sm text-[#747d8c] transition hover:border-[#bfc6e8] hover:bg-white hover:text-[#3f51bd]"
                >
                  <MapPin size={15} />
